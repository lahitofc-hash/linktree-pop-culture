...
const StreamingCard = ({ platform, url, themeColor }: any) => {
  const icons: any = { spotify: Icons.Music, youtube: Icons.Play, apple: Icons.Apple, soundcloud: Icons.Cloud, tidal: Icons.Waves, deezer: Icons.Headphones, amazon: Icons.ShoppingBag };
